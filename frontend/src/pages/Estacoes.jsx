      ...
      {mostrarModal && (
        <div className="modal d-block" style={{ background: 'rgba(0,0,0,0.5)' }}>
          <div className="modal-dialog"><div className="modal-content">
            ...
            {/* começo do formulário etapa 1: dados da estação */}
            {etapa === 1 && (
              <form onSubmit={salvarEtapa1}>
                <div className="modal-body">
                  ...
                  {/* campos latitude e longitude lado a lado */}
            ...
            {/* fim do formulário etapa 1 */}

            {/* começo do formulário etapa 2: tipos vinculados */}
            {etapa === 2 && (
              <div>
                <div className="modal-body">
                  ...
                  {tipos.map(function(tipo) {
                    ...
                    return (
                      <div key={tipo.id} className="mb-2">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          {/* checkbox: marcado = tipo vinculado à estação */}
                          <input className="form-check-input" type="checkbox"
                          ...
                          {/* lápis abre o formulário de edição inline deste tipo */}
                          {ehAdmin && (
                        ...
                        {/* começo do formulário inline do lápis */}
                        {esteEditando && (
                        ...
                        {/* fim do formulário inline do lápis */}
                  ...
                  {/* começo do formulário de novo tipo inline */}
                  {mostrarFormTipo && (
                  ...
                  {/* fim do formulário de novo tipo inline */}
